...
__all__: list[str] = ['Any', 'backend', 'collision_driver', 'constraint', 'copy', 'get_data', 'get_data_into', 'has_cuda_gpu_device', 'jax', 'jp', 'logging', 'make_data', 'mesh', 'mjwp', 'mjwp_types', 'mjxw', 'mujoco', 'np', 'os', 'put_data', 'put_model', 'scipy', 'support', 'types', 'warnings', 'wp']
def _check_impl_device_compatibility(impl: typing.Union[str, mujoco.mjx._src.types.Impl], device: jaxlib._jax.Device) -> None:
    """
...
def _get_contact(c: mujoco._structs._MjContactList, cx: mujoco.mjx._src.types.Contact):
    ...
    """
def _get_data_into(result: typing.Union[mujoco._structs.MjData, typing.List[mujoco._structs.MjData]], m: mujoco._structs.MjModel, d: mujoco.mjx._src.types.Data):
    """
    Gets mjx.Data from a device into an existing mujoco.MjData or list.
    """
def _get_data_into_warp(result: typing.Union[mujoco._structs.MjData, typing.List[mujoco._structs.MjData]], m: mujoco._structs.MjModel, d: mujoco.mjx._src.types.Data):
    """
    Gets mjx.Data from a device into an existing mujoco.MjData or list.
    """
...
def _is_cuda_gpu_device(device: jaxlib._jax.Device) -> bool:
    ...
def _make_data_c(m: typing.Union[mujoco.mjx._src.types.Model, mujoco._structs.MjModel], device: typing.Optional[jaxlib._jax.Device] = None) -> mujoco.mjx._src.types.Data:
    """
    Allocate and initialize Data for the C implementation.
    """
def _make_data_contact_jax(condim: numpy.ndarray, efc_address: numpy.ndarray) -> mujoco.mjx._src.types.Contact:
    """
    Create contact for the Data object.
    """
def _make_data_jax(m: typing.Union[mujoco.mjx._src.types.Model, mujoco._structs.MjModel], device: typing.Optional[jaxlib._jax.Device] = None) -> mujoco.mjx._src.types.Data:
    """
    Allocate and initialize Data for the JAX implementation.
    """
def _make_data_public_fields(m: mujoco.mjx._src.types.Model) -> typing.Dict[str, typing.Any]:
    """
    Create public fields for the Data object.
    """
def _make_data_warp(m: typing.Union[mujoco.mjx._src.types.Model, mujoco._structs.MjModel], device: typing.Optional[jaxlib._jax.Device] = None, nconmax: typing.Optional[int] = None, njmax: typing.Optional[int] = None) -> mujoco.mjx._src.types.Data:
    """
    Allocate and initialize Data for the Warp implementation.
    """
def _put_contact(c: mujoco._structs._MjContactList, dim: numpy.ndarray, efc_address: numpy.ndarray) -> typing.Tuple[mujoco.mjx._src.types.Contact, numpy.ndarray]:
    """
    Converts mujoco.structs._MjContactList into mjx.Contact.
    """
def _put_data_c(m: mujoco._structs.MjModel, d: mujoco._structs.MjData, device: typing.Optional[jaxlib._jax.Device] = None) -> mujoco.mjx._src.types.Data:
    """
    Puts mujoco.MjData onto a device, resulting in mjx.Data.
    """
def _put_data_jax(m: mujoco._structs.MjModel, d: mujoco._structs.MjData, device: typing.Optional[jaxlib._jax.Device] = None) -> mujoco.mjx._src.types.Data:
    """
    Puts mujoco.MjData onto a device, resulting in mjx.Data.
    """
def _put_data_public_fields(d: mujoco._structs.MjData) -> typing.Dict[str, typing.Any]:
    ...
    """
def _put_model_c(m: mujoco._structs.MjModel, device: typing.Optional[jaxlib._jax.Device] = None) -> mujoco.mjx._src.types.Model:
    """
    Puts mujoco.MjModel onto a device, resulting in mjx.Model.
    """
def _put_model_jax(m: mujoco._structs.MjModel, device: typing.Optional[jaxlib._jax.Device] = None) -> mujoco.mjx._src.types.Model:
    """
    Puts mujoco.MjModel onto a device, resulting in mjx.Model.
    """
def _put_model_warp(m: mujoco._structs.MjModel, device: typing.Optional[jaxlib._jax.Device] = None) -> mujoco.mjx._src.types.Model:
    """
    Puts mujoco.MjModel onto a device, resulting in mjx.Model.
    """
def _put_option(o: mujoco._structs.MjOption, impl: mujoco.mjx._src.types.Impl, impl_fields: typing.Optional[typing.Dict[str, typing.Any]] = None) -> mujoco.mjx._src.types.Option:
    """
    Returns mjx.Option given mujoco.MjOption.
    """
def _put_statistic(s: mujoco._structs.MjStatistic, impl: mujoco.mjx._src.types.Impl) -> typing.Union[mujoco.mjx._src.types.Statistic, mujoco.mjx._src.types.StatisticWarp]:
    """
...
def _resolve_impl(device: jaxlib._jax.Device) -> mujoco.mjx._src.types.Impl:
    ...
    """
def _resolve_impl_and_device(impl: typing.Union[str, mujoco.mjx._src.types.Impl, NoneType], device: typing.Optional[jaxlib._jax.Device] = None) -> typing.Tuple[mujoco.mjx._src.types.Impl, jaxlib._jax.Device]:
    """
