...
def _efc_contact_elliptic(
    m: mujoco.mjx._src.types.Model, d: mujoco.mjx._src.types.Data, condim: int
) -> typing.Optional[mujoco.mjx._src.constraint._Efc]:
    """
...
def _kbi(
    m: mujoco.mjx._src.types.Model, solref: jax.Array, solimp: jax.Array, pos: jax.Array
...
def make_efc_type(
    m: typing.Union[mujoco.mjx._src.types.Model, mujoco._structs.MjModel],
    dim: typing.Optional[numpy.ndarray] = None,
) -> numpy.ndarray:
    """
