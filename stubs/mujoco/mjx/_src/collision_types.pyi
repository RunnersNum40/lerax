...
class FunctionKey:
    ...
    def __init__(
        self,
        types: typing.Tuple[int, int],
        data_ids: typing.Tuple[int, int],
        condim: int,
        subgrid_size: typing.Tuple[int, int] = (-1, -1),
    ) -> None: ...
    def __replace__(self, **changes): ...
    def __repr__(self): ...
    def __setattr__(self, name, value): ...
