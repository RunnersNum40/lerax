...
def _clearance(
    d1: typing.Callable[[jax.Array], jax.Array],
    d2: typing.Callable[[jax.Array], jax.Array],
...
def _from_to(
    f: typing.Callable[[jax.Array], jax.Array],
    from_pos: jax.Array,
    from_mat: jax.Array,
    to_pos: jax.Array,
    to_mat: jax.Array,
...
def _gradient_descent(
    objective: typing.Callable[[jax.Array], jax.Array], x: jax.Array, niter: int
...
def _gradient_step(
    objective: typing.Callable[[jax.Array], jax.Array], state: GradientState
) -> GradientState:
    """
...
def _optim(
    d1,
    d2,
    info1: mujoco.mjx._src.collision_types.GeomInfo,
    info2: mujoco.mjx._src.collision_types.GeomInfo,
    x0: jax.Array,
...
)  # value = <jax._src.custom_derivatives.custom_jvp object>
