...
__all__: list[str] = ['ConeType', 'Context', 'Data', 'DataJAX', 'DisableBit', 'Model', 'ModelJAX', 'OptionJAX', 'PyTreeNode', 'SolverType', 'jax', 'jp', 'math', 'mujoco', 'smooth', 'solve', 'support']
class Context(mujoco.mjx._src.dataclasses.PyTreeNode):
    ...
    def replace(obj, **changes):
        ...
        """
    @classmethod
    def create(cls, m: mujoco.mjx._src.types.Model, d: mujoco.mjx._src.types.Data, grad: bool = True) -> Context:
        ...
...
class _LSPoint(mujoco.mjx._src.dataclasses.PyTreeNode):
    ...
    def replace(obj, **changes):
        ...
        """
    @classmethod
    def create(cls, m: mujoco.mjx._src.types.Model, d: mujoco.mjx._src.types.Data, ctx: Context, alpha: jax.Array, jv: jax.Array, quad: jax.Array, quad_gauss: jax.Array, uu: jax.Array, v0: jax.Array, uv: jax.Array, vv: jax.Array) -> _LSPoint:
        """
