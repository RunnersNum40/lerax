...
class BindData:
    ...
    def __init__(
        ...
        specs: collections.abc.Sequence[
            typing.Union[
    ...
    def _slice(
        self, name: str, idx: typing.Union[int, slice, collections.abc.Sequence[int]]
    ): ...
...
def _bind_data(
    self: mujoco.mjx._src.types.Data,
    model: mujoco.mjx._src.types.Model,
    obj: typing.Union[
        mujoco._specs.MjsBody,
        mujoco._specs.MjsFrame,
...
def _bind_model(
    self: mujoco.mjx._src.types.Model,
    obj: typing.Union[
        mujoco._specs.MjsBody,
        mujoco._specs.MjsFrame,
        mujoco._specs.MjsGeom,
...
def contact_force_dim(
    m: mujoco.mjx._src.types.Model, d: mujoco.mjx._src.types.Data, dim: int
) -> typing.Tuple[jax.Array, numpy.ndarray]:
    """
...
def make_m(
    ...
    a: jax.Array,
    b: jax.Array,
    d: typing.Optional[jax.Array] = None,
) -> jax.Array:
    """
...
def mul_m(
    m: mujoco.mjx._src.types.Model, d: mujoco.mjx._src.types.Data, vec: jax.Array
) -> jax.Array:
    """
...
def wrap_inside(
    end: jax.Array, radius: jax.Array, maxiter: int, tolerance: float, z_init: float
) -> typing.Tuple[jax.Array, jax.Array]:
    """
