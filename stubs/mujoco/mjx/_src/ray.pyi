...
def _ray_triangle(
    vert: jax.Array, pnt: jax.Array, vec: jax.Array, basis: jax.Array
) -> jax.Array:
    """
...
def ray(
    ...
    pnt: jax.Array,
    vec: jax.Array,
    geomgroup: typing.Sequence[int] = tuple(),
...
def ray_geom(
    ...
    pnt: jax.Array,
    vec: jax.Array,
    geomtype: mujoco.mjx._src.types.GeomType,
) -> jax.Array:
    """
