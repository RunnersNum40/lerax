...
class HalfCheetah(AbstractMujocoEnv[Float[Array, "..."], Float[Array, "..."]]):
    """MJX-based half-cheetah environment matching Gymnasium's HalfCheetah-v5."""

    name: ClassVar[str] = "HalfCheetah"
    ...
    def __init__(
        self,
        *,
        xml_file: str | Path = "half_cheetah.xml",
        frame_skip: int = 5,
        ...
        if not asset_path.exists():
            raise FileNotFoundError(f"HalfCheetah asset not found: {asset_path}")
