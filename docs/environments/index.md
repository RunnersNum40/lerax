...
The logic for all parts of the reinforcement learning task are separated into different components, such as the `initial`, `transition`, `observation`, `reward`, `terminal`, and `truncate` functions.
...
If you'd like an identical Gymnasium-style API, you can use [`LeraxToGymEnv`][lerax.compatibility.gym.LeraxToGymEnv] to wrap any Lerax environment.

## Environment Families

| Family | Description |
|---|---|
| [MuJoCo](mujoco/index.md) | Gymnasium MuJoCo environments (Ant, Humanoid, etc.) |
| [Classic Control](classic_control/index.md) | Gymnasium Classic Control environments (CartPole, etc.) |
| [Unitree](unitree/index.md) | Unitree humanoid robots with domain randomization |
